...
class ShopifyVariant < ApplicationRecord
  ...
  belongs_to :product, class_name: "ShopifyProduct", foreign_key: "productId",
    inverse_of: :variants, optional: true

  has_many :sku_links, class_name: "SkuLink", foreign_key: "shopifyVariantId",
    dependent: :nullify
