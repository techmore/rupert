...
class CreateCatalogSchema < ActiveRecord::Migration[7.1]
  def change
    ...
    add_index 'SkuLink', %w[shopifyVariantId squareVariationId], unique: true,
                                                                 name: 'SkuLink_shopifyVariantId_squareVariationId_key'
    ...
    add_index 'Location', %w[source externalId], unique: true
    ...
    add_index 'InventoryLevel', %w[source locationId shopifyVariantId], unique: true
    add_index 'InventoryLevel', %w[source locationId squareVariationId], unique: true
