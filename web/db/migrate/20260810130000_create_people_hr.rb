...
class CreatePeopleHr < ActiveRecord::Migration[8.1]
  def change
    ...
    create_table(:positions) do |t|
      ...
      t.index(%i[tenant_id department_id])
    ...
    create_table(:employees) do |t|
      ...
      t.index(%i[tenant_id employee_number], unique: true)
      t.index(%i[tenant_id department_id])
      t.index(%i[tenant_id position_id])
      t.index(%i[tenant_id user_id])
      t.index(%i[tenant_id status])
    end

    add_reference(:departments, :manager, type: :bigint, index: false, foreign_key: { to_table: :employees },
                                          null: true)
    ...
    create_table(:pay_rates) do |t|
      ...
      t.index(%i[tenant_id employee_id])
      t.index(%i[tenant_id effective_on])
    end
    ...
    create_table(:timesheets) do |t|
      ...
      t.index(%i[tenant_id employee_id period_start], unique: true)
      t.index(%i[tenant_id status])
    end
    ...
    create_table(:timesheet_entries) do |t|
      ...
      t.index(%i[tenant_id timesheet_id])
    end
    ...
    create_table(:leave_balances) do |t|
      ...
      t.index(%i[tenant_id employee_id leave_type year], unique: true)
    end
    ...
    create_table(:leave_requests) do |t|
      ...
      t.index(%i[tenant_id employee_id status])
      t.index(%i[tenant_id status])
    end
    ...
    create_table(:pay_runs) do |t|
      ...
      t.index(%i[tenant_id period_start])
      t.index(%i[tenant_id status])
    end
    ...
    create_table(:payslips) do |t|
      ...
      t.index(%i[tenant_id pay_run_id])
      t.index(%i[tenant_id employee_id])
    end
  end
end
