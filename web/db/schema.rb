...
ActiveRecord::Schema[8.1].define(version: 20_260_821_040_000) do
  ...
  create_table 'BackupLog', id: :string, force: :cascade do |t|
    ...
    t.string 'tenant_id'
    t.index %w[tenant_id startedAt], name: 'index_BackupLog_on_tenant_id_and_startedAt'
  end
  ...
  create_table 'InventoryCount', id: :string, force: :cascade do |t|
    ...
    t.string 'tenant_id'
    t.index %w[tenant_id countedAt], name: 'index_InventoryCount_on_tenant_id_and_countedAt'
  end
  ...
  create_table 'InventoryLevel', id: :string, force: :cascade do |t|
    ...
    t.index %w[tenant_id source locationId shopifyVariantId],
            name: 'idx_inventory_levels_tenant_source_loc_shopify', unique: true
    t.index %w[tenant_id source locationId squareVariationId],
            name: 'idx_inventory_levels_tenant_source_loc_square', unique: true
    t.index %w[tenant_id source shopifyVariantId], name: 'idx_inventory_levels_tenant_source_shopify_variant'
    t.index %w[tenant_id source squareVariationId], name: 'idx_inventory_levels_tenant_source_square_variation'
  ...
  create_table 'InventoryMovement', id: :string, force: :cascade do |t|
    ...
    t.index %w[tenant_id sku], name: 'idx_inventory_movements_tenant_sku'
    t.index %w[tenant_id source createdAt], name: 'idx_inventory_movements_tenant_source_created_at'
    t.index %w[tenant_id squareVariationId], name: 'idx_inventory_movements_tenant_square_variation'
  ...
  create_table 'LedgerEntry', id: :string, force: :cascade do |t|
    ...
    t.index %w[tenant_id occurredAt], name: 'idx_ledger_entries_tenant_occurred_at'
  ...
  create_table 'Location', id: :string, force: :cascade do |t|
    ...
    t.index %w[tenant_id source externalId], name: 'index_Location_on_tenant_source_externalId', unique: true
    t.index %w[tenant_id source primary_location], name: 'idx_locations_tenant_source_primary'
  ...
  create_table 'ShopifyVariant', id: :string, force: :cascade do |t|
    ...
    t.index %w[sku productId], name: 'idx_shopify_variants_sku_product'
    t.index ['sku'], name: 'idx_trgm_shopifyvariant_sku', opclass: :gin_trgm_ops, using: :gin
    t.index ['sku'], name: 'index_ShopifyVariant_on_sku'
    t.index %w[tenant_id inventoryItemId], name: 'idx_shopify_variants_tenant_inventory_item_id'
  ...
  create_table 'SkuLink', id: :string, force: :cascade do |t|
    ...
    t.string 'squareVariationId'
    t.string 'tenant_id'
    t.index %w[shopifyVariantId squareVariationId], name: 'SkuLink_shopifyVariantId_squareVariationId_key',
                                                    unique: true
    t.index ['shopifyVariantId'], name: 'index_SkuLink_on_shopifyVariantId', unique: true
    t.index ['sku'], name: 'index_SkuLink_on_sku'
    t.index %w[tenant_id squareVariationId], name: 'idx_sku_links_tenant_square_variation'
  ...
  create_table 'SyncRun', id: :string, force: :cascade do |t|
    ...
    t.index %w[status finishedAt], name: 'idx_sync_runs_status_finished_at'
    t.index ['status'], name: 'index_SyncRun_on_status'
    t.index ['tenant_id'], name: 'index_SyncRun_on_running_per_tenant', unique: true,
  ...
  create_table 'WarehouseTier', id: :string, force: :cascade do |t|
    ...
    t.string 'shareId'
    t.index %w[shareId minQty], name: 'index_WarehouseTier_on_shareId_and_minQty', unique: true
  ...
  create_table 'access_logs', force: :cascade do |t|
    ...
    t.string 'user_agent'
    t.bigint 'user_id'
    t.index %w[tenant_id created_at], name: 'index_access_logs_on_tenant_id_and_created_at'
    t.index %w[tenant_id status], name: 'index_access_logs_on_tenant_id_and_status'
  ...
  create_table 'accounts', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index %w[tenant_id account_type], name: 'index_accounts_on_tenant_id_and_account_type'
    t.index %w[tenant_id code], name: 'index_accounts_on_tenant_id_and_code', unique: true
  end
  ...
  create_table 'activity_logs', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.bigint 'user_id'
    t.index %w[tenant_id created_at], name: 'index_activity_logs_on_tenant_id_and_created_at'
    t.index %w[tenant_id subject_type subject_id], name: 'idx_on_tenant_id_subject_type_subject_id_034734a708'
  end
  ...
  create_table 'customers', force: :cascade do |t|
    ...
    t.index %w[tenant_id email], name: 'index_customers_on_tenant_id_and_email'
    t.index %w[tenant_id external_id source], name: 'index_customers_on_tenant_id_and_external_id_and_source',
                                              unique: true
    t.index %w[tenant_id phone], name: 'index_customers_on_tenant_id_and_phone'
  end
  ...
  create_table 'departments', force: :cascade do |t|
    ...
    t.string 'tenant_id', null: false
    t.datetime 'updated_at', null: false
    t.index %w[tenant_id name], name: 'index_departments_on_tenant_id_and_name', unique: true
  end
  ...
  create_table 'employees', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.bigint 'user_id'
    t.index %w[tenant_id department_id], name: 'index_employees_on_tenant_id_and_department_id'
    t.index %w[tenant_id employee_number], name: 'index_employees_on_tenant_id_and_employee_number', unique: true
    t.index %w[tenant_id position_id], name: 'index_employees_on_tenant_id_and_position_id'
    t.index %w[tenant_id status], name: 'index_employees_on_tenant_id_and_status'
    t.index %w[tenant_id user_id], name: 'index_employees_on_tenant_id_and_user_id'
  end
  ...
  create_table 'expenses', force: :cascade do |t|
    ...
    t.index %w[tenant_id category], name: 'index_expenses_on_tenant_id_and_category'
    t.index %w[tenant_id incurred_on], name: 'index_expenses_on_tenant_id_and_incurred_on'
  end
  ...
  create_table 'fulfillments', force: :cascade do |t|
    ...
    t.index %w[source source_fulfillment_id], name: 'index_fulfillments_on_source_and_source_fulfillment_id',
                                              unique: true
    t.index %w[tenant_id order_id], name: 'index_fulfillments_on_tenant_id_and_order_id'
  end
  ...
  create_table 'goals', force: :cascade do |t|
    ...
    t.string 'unit'
    t.datetime 'updated_at', null: false
    t.index %w[tenant_id status], name: 'index_goals_on_tenant_id_and_status'
  end
  ...
  create_table 'kpi_readings', force: :cascade do |t|
    ...
    t.index %w[tenant_id kpi_id measured_at], name: 'index_kpi_readings_on_tenant_id_and_kpi_id_and_measured_at'
  end
  ...
  create_table 'kpis', force: :cascade do |t|
    ...
    t.string 'unit'
    t.datetime 'updated_at', null: false
    t.index %w[tenant_id name], name: 'index_kpis_on_tenant_id_and_name'
  end
  ...
  create_table 'leave_balances', force: :cascade do |t|
    ...
    t.index %w[tenant_id employee_id leave_type year],
            name: 'idx_on_tenant_id_employee_id_leave_type_year_960082e46c', unique: true
  end
  ...
  create_table 'leave_requests', force: :cascade do |t|
    ...
    t.string 'tenant_id', null: false
    t.datetime 'updated_at', null: false
    t.index %w[tenant_id employee_id status], name: 'index_leave_requests_on_tenant_id_and_employee_id_and_status'
    t.index %w[tenant_id status], name: 'index_leave_requests_on_tenant_id_and_status'
  end
  ...
  create_table 'oauth_allowed_domains', force: :cascade do |t|
    ...
    t.string 'tenant_id'
    t.datetime 'updated_at', null: false
    t.index %w[tenant_id domain], name: 'index_oauth_allowed_domains_on_tenant_id_and_domain', unique: true
  end
  ...
  create_table 'order_lines', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index %w[tenant_id order_id], name: 'index_order_lines_on_tenant_id_and_order_id'
    t.index %w[tenant_id sku], name: 'index_order_lines_on_tenant_id_and_sku'
  end
  ...
  create_table 'orders', force: :cascade do |t|
    ...
    t.index %w[tenant_id customer_id], name: 'index_orders_on_tenant_id_and_customer_id'
    t.index %w[tenant_id occurred_at], name: 'index_orders_on_tenant_id_and_occurred_at'
    t.index %w[tenant_id order_number], name: 'index_orders_on_tenant_id_and_order_number'
    t.index %w[tenant_id source source_order_id],
            name: 'index_orders_on_tenant_id_and_source_and_source_order_id', unique: true
    t.index %w[tenant_id status], name: 'index_orders_on_tenant_id_and_status'
  end
  ...
  create_table 'pay_rates', force: :cascade do |t|
    ...
    t.string 'tenant_id', null: false
    t.datetime 'updated_at', null: false
    t.index %w[tenant_id effective_on], name: 'index_pay_rates_on_tenant_id_and_effective_on'
    t.index %w[tenant_id employee_id], name: 'index_pay_rates_on_tenant_id_and_employee_id'
  end
  ...
  create_table 'pay_runs', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index %w[tenant_id period_start], name: 'index_pay_runs_on_tenant_id_and_period_start'
    t.index %w[tenant_id status], name: 'index_pay_runs_on_tenant_id_and_status'
  end
  ...
  create_table 'payments', force: :cascade do |t|
    ...
    t.string 'tenant_id', null: false
    t.datetime 'updated_at', null: false
    t.index %w[tenant_id order_id], name: 'index_payments_on_tenant_id_and_order_id'
    t.index %w[tenant_id paid_at], name: 'index_payments_on_tenant_id_and_paid_at'
  end
  ...
  create_table 'payslips', force: :cascade do |t|
    ...
    t.string 'tenant_id', null: false
    t.datetime 'updated_at', null: false
    t.index %w[tenant_id employee_id], name: 'index_payslips_on_tenant_id_and_employee_id'
    t.index %w[tenant_id pay_run_id], name: 'index_payslips_on_tenant_id_and_pay_run_id'
  end
  ...
  create_table 'pos_sessions', force: :cascade do |t|
    ...
    t.index %w[tenant_id opened_at], name: 'index_pos_sessions_on_tenant_id_and_opened_at'
    t.index %w[tenant_id status], name: 'index_pos_sessions_on_tenant_id_and_status'
  end
  ...
  create_table 'positions', force: :cascade do |t|
    ...
    t.string 'tenant_id', null: false
    t.datetime 'updated_at', null: false
    t.index %w[tenant_id department_id], name: 'index_positions_on_tenant_id_and_department_id'
    t.index %w[tenant_id name], name: 'index_positions_on_tenant_id_and_name'
  end
  ...
  create_table 'projects', force: :cascade do |t|
    ...
    t.string 'tenant_id', null: false
    t.datetime 'updated_at', null: false
    t.index %w[tenant_id owner_id], name: 'index_projects_on_tenant_id_and_owner_id'
    t.index %w[tenant_id status], name: 'index_projects_on_tenant_id_and_status'
  end
  ...
  create_table 'purchase_order_lines', force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.index %w[tenant_id purchase_order_id], name: 'index_purchase_order_lines_on_tenant_id_and_purchase_order_id'
    t.index %w[tenant_id sku], name: 'index_purchase_order_lines_on_tenant_id_and_sku'
  end
  ...
  create_table 'purchase_orders', force: :cascade do |t|
    ...
    t.index %w[tenant_id order_number], name: 'index_purchase_orders_on_tenant_id_and_order_number', unique: true
    t.index %w[tenant_id status], name: 'index_purchase_orders_on_tenant_id_and_status'
    t.index %w[tenant_id vendor_id], name: 'index_purchase_orders_on_tenant_id_and_vendor_id'
  end
  ...
  create_table 'refunds', force: :cascade do |t|
    ...
    t.index %w[tenant_id order_id], name: 'index_refunds_on_tenant_id_and_order_id'
    t.index %w[tenant_id refunded_at], name: 'index_refunds_on_tenant_id_and_refunded_at'
  end
  ...
  create_table 'role_permissions', force: :cascade do |t|
    ...
    t.string 'tenant_id', null: false
    t.datetime 'updated_at', null: false
    t.index %w[tenant_id role permission], name: 'index_role_permissions_on_tenant_id_and_role_and_permission',
                                           unique: true
    t.index %w[tenant_id role], name: 'index_role_permissions_on_tenant_id_and_role'
  end
  ...
  create_table 'settings', force: :cascade do |t|
    ...
    t.string 'value'
    t.index %w[key tenant_id], name: 'index_settings_on_key_and_tenant_id', unique: true
  end
  ...
  create_table 'size_changes', force: :cascade do |t|
    ...
    t.string 'tenant_id'
    t.datetime 'updated_at', null: false
    t.index %w[family_id sku], name: 'index_size_changes_on_family_id_and_sku', unique: true
    t.index ['family_id'], name: 'index_size_changes_on_family_id'
    t.index %w[tenant_id status], name: 'index_size_changes_on_tenant_id_and_status'
  ...
  create_table 'size_family_members', force: :cascade do |t|
    ...
    t.string 'tenant_id'
    t.datetime 'updated_at', null: false
    t.index %w[family_id sku], name: 'index_size_family_members_on_family_id_and_sku', unique: true
  ...
  create_table 'tasks', force: :cascade do |t|
    ...
    t.string 'title', null: false
    t.datetime 'updated_at', null: false
    t.index %w[tenant_id assignee_id], name: 'index_tasks_on_tenant_id_and_assignee_id'
    t.index %w[tenant_id project_id], name: 'index_tasks_on_tenant_id_and_project_id'
    t.index %w[tenant_id status], name: 'index_tasks_on_tenant_id_and_status'
  end
  ...
  create_table 'timesheet_entries', force: :cascade do |t|
    ...
    t.index %w[tenant_id timesheet_id], name: 'index_timesheet_entries_on_tenant_id_and_timesheet_id'
  end
  ...
  create_table 'timesheets', force: :cascade do |t|
    ...
    t.string 'tenant_id', null: false
    t.datetime 'updated_at', null: false
    t.index %w[tenant_id employee_id period_start],
            name: 'index_timesheets_on_tenant_id_and_employee_id_and_period_start', unique: true
    t.index %w[tenant_id status], name: 'index_timesheets_on_tenant_id_and_status'
  end
  ...
  create_table 'user_permissions', force: :cascade do |t|
    ...
    t.index %w[tenant_id user_id permission],
            name: 'index_user_permissions_on_tenant_id_and_user_id_and_permission', unique: true
    t.index %w[tenant_id user_id], name: 'index_user_permissions_on_tenant_id_and_user_id'
  end
  ...
  create_table 'vendor_payments', force: :cascade do |t|
    ...
    t.index %w[tenant_id paid_on], name: 'index_vendor_payments_on_tenant_id_and_paid_on'
    t.index %w[tenant_id vendor_id], name: 'index_vendor_payments_on_tenant_id_and_vendor_id'
  end
  ...
  create_table 'vendors', force: :cascade do |t|
    ...
    t.string 'tenant_id', null: false
    t.datetime 'updated_at', null: false
    t.index %w[tenant_id name], name: 'index_vendors_on_tenant_id_and_name', unique: true
  end
  ...
  create_table 'warehouse_cart_items', force: :cascade do |t|
    ...
    t.index %w[cart_id variant_id], name: 'index_warehouse_cart_items_on_cart_id_and_variant_id', unique: true
    t.index %w[tenant_id share_id], name: 'index_warehouse_cart_items_on_tenant_id_and_share_id'
  end
  ...
  create_table 'warehouse_carts', force: :cascade do |t|
    ...
    t.string 'token', null: false
    t.datetime 'updated_at', null: false
    t.index %w[tenant_id share_id], name: 'index_warehouse_carts_on_tenant_id_and_share_id'
