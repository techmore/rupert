...
class FinanceFlowTest < ActionDispatch::IntegrationTest
  ...
  test "record an expense and it shows in the register" do
    ...
    post finance_expenses_path, params: {
      expense: { payee: "Utility Co", category: "utilities", amount: "125.50", incurred_on: "2026-08-01", method: "bank_transfer" },
      shop: "m11u0i-sb.myshopify.com",
      embedded: "1",
    }
    follow_redirect!
    ...
    assert_equal 12550, expense.amount_cents
  ...
  test "vendor payments index lists recent payments" do
    ...
    Finance::VendorPayment.create!(tenant_id: @tenant.id, vendor_id: vendor.id, amount_cents: 2500, paid_on: Date.today, method: "ach")
