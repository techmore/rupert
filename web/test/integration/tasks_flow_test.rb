...
class TasksFlowTest < ActionDispatch::IntegrationTest
  ...
  setup do
    ...
    @task = Projects::Task.create!(project: @project, title: "Fix duplicate SKUs", priority: "high", tenant_id: @tenant.id)
  end
  ...
  test "task transition finishes a task" do
    ...
    post transition_projects_task_path(@task, event: "finish"), params: { shop: "m11u0i-sb.myshopify.com", embedded: "1" }
