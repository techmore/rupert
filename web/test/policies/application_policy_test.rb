...
class ApplicationPolicyTest < ActiveSupport::TestCase
  setup do
    ...
    @other = Tenant.create!(name: 'Other Store', subdomain: 'other', shopify_shop_domain: 'other.myshopify.com',
                            status: 'active')

    @super_admin = User.create!(email: 'platform@example.com', password: 'password123', role: 'super_admin',
                                tenant_id: @home.id, name: 'Platform')
    @manager = User.create!(email: 'manager@example.com', password: 'password123', role: 'manager',
                            tenant_id: @home.id, name: 'Mgr')
  end
