...
class ShopifySkuConsolidatorTest < ActiveSupport::TestCase
  setup do
    ...
    @p1 = ShopifyProduct.create!(id: 'P1', title: 'Citrus Burst Live Resin', status: 'ACTIVE',
                                 tenant_id: Current.tenant_id)
    @p2 = ShopifyProduct.create!(id: 'P2', title: 'Trop Z Live Resin', status: 'ACTIVE', tenant_id: Current.tenant_id)
    @v1 = ShopifyVariant.create!(id: 'SV1', productId: 'P1', title: '5 Grams', sku: 'LR5', tracked: true,
                                 tenant_id: Current.tenant_id)
    @v2 = ShopifyVariant.create!(id: 'SV2', productId: 'P2', title: '5 Grams', sku: 'LR5', tracked: true,
                                 tenant_id: Current.tenant_id)
  end
  ...
  test 'prefers an ACTIVE product variant as canonical over an ARCHIVED one' do
    ShopifyProduct.create!(id: 'P3', title: 'Citrus Burst Live Resin', status: 'ARCHIVED',
                           tenant_id: Current.tenant_id)
    @v3 = ShopifyVariant.create!(id: 'SV3', productId: 'P3', title: '5 Grams', sku: 'LR9', tracked: true,
                                 tenant_id: Current.tenant_id)
