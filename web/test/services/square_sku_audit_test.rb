...
class SquareSkuAuditTest < ActiveSupport::TestCase
  ...
  test "classifies sellable-but-unlinked variations" do
    stub_square_api
    product = ShopifyProduct.create!(id: "P1", title: "Herb", tenant_id: Current.tenant_id)
    variant = ShopifyVariant.create!(id: "SV1", productId: "P1", title: "Herb 1", sku: "HERB-1", tracked: true, tenant_id: Current.tenant_id)
    ...
    SkuLink.create!(sku: "HERB-1", shopifyVariantId: variant.id, squareVariationId: "V1", auto: true, tenant_id: Current.tenant_id)
    result = SquareSkuAudit.run!
